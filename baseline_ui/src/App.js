...
export default function App() {
  ...
  let addToSavedImages = (images) => {
    ...
    if (!manual) {
      ...
      fetch('http://127.0.0.1:5000/logSavedImages', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
      ...
      <Dialog open={isOpen}>
        ...
        <DialogContent>
          <div className="side-by-side">
            <button className="button-12" onClick={() => handleChange(0)}>Transportation</button>
            <button className="button-12" onClick={() => handleChange(1)}>Music Festival</button>
            {/* <button className="button-12" onClick={() => handleChange(2)}>2</button> */}
            {/* <button className="button-12" onClick={() => handleChange(4)}>3</button> */}
            <button className="button-12" onClick={() => handleChange(5)}>Wedding</button>
